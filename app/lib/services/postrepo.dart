...
class PostRepo {
  ...
  List<Ground> tempList = [
    ...
    Ground(
      ...
      sprots: ["Criket", "FootBall", "BasketBall"],
      location: Location(
          area: "Motera", city: "Ahmedabad", road: "On Road", state: "Gujarat"),
      star: 4.5,
      bookmark: false,
      contact: Contact(name: "Dhruv Kabariya", phone: "+911234567890"),
    ),
  ...
  Future<List<Ground>> fetchGround() async {
    ...
    this.grounds.addAll(this.tempList);
    this.seeGround.addAll(this.tempList);
  ...
  List<Ground> bookmarkGround() {
    return this.tempList.where((ground) => ground.bookmark).toList();
  }
